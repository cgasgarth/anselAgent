...
install_macos_deps() {
  ...
  info "Installing Ansel build dependencies via Homebrew..."
...
install_linux_deps() {
  info "On Linux, install Ansel build dependencies using your package manager."
  info "Examples:"
  info "  Fedora/RHEL:   install the package set needed to build Ansel"
  info "  Ubuntu/Debian: install the package set needed to build Ansel"
  info "  OpenSuse:      install the package set needed to build Ansel"
...
info "  npm run ansel:build       # build Ansel"
info "  npm run server:start      # start the backend"
info "  npm run ansel:start       # start Ansel"
