...
def evaluation_corpus() -> list[EvaluationCase]:
    return [
        ...
        _make_case(
            ...
            description="Mixed-lighting event correction with white-balance cleanup and restrained tonal recovery.",
            request_text="Fix this mixed-light event frame, keep the subject natural, and balance the exposure and white balance cleanly.",
            ...
            expectations=EvaluationExpectations(
                ...
                assistant_text_includes=("mixed-light", "natural"),
                continue_refining=False,
            ),
            thresholds=EvaluationThresholds(
                max_resolved_operation_count=3,
                max_tool_calls_used=3,
                max_pass_count=2,
                max_highlight_clip_ratio=0.0,
                max_shadow_crush_ratio=0.12,
            ...
            plan_payload={
                "assistantText": "Golden mixed-lighting correction with natural color balance.",
                "continueRefining": False,
                "operations": [],
                "canonicalActions": [
                    {
